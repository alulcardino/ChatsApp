...
object NetworkModule {
    ...
    fun provideOkHttpClient(authInterceptor: AuthInterceptor): OkHttpClient {
        return OkHttpClient.Builder()
            ...
            .connectTimeout(5, TimeUnit.SECONDS)  // Тайм-аут на установку соединения
            .readTimeout(5, TimeUnit.SECONDS)     // Тайм-аут на чтение данных
            .writeTimeout(5, TimeUnit.SECONDS)    // Тайм-аут на запись данных
            .build()
    }
